...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    // Temporarily disable CSV loading to test basic rendering
    // loadYouTubeData()
    
    // Set sample data immediately for testing
    setKpiData({
      subscriberGrowth: {
        current: 12500,
        previous: 11800,
  ...
  const engagementData = chartData?.engagementData || Array.from({ length: 30 }, (_, i) => ({
    ...
    shares: Math.floor(Math.random() * 150) + 100
  }))
  ...
  const topicCategoriesData = chartData?.topicCategoriesData || [
    { name: 'Gaming', views: 2500000, engagement: 125000, videos: 45, avgViews: 55555, avgEngagement: 2777, avgDuration: 1200 },
    { name: 'Music', views: 1800000, engagement: 90000, videos: 32, avgViews: 56250, avgEngagement: 2812, avgDuration: 1800 },
    { name: 'Tutorial', views: 1200000, engagement: 60000, videos: 28, avgViews: 42857, avgEngagement: 2142, avgDuration: 900 },
    { name: 'Review', views: 800000, engagement: 40000, videos: 25, avgViews: 32000, avgEngagement: 1600, avgDuration: 1500 },
    { name: 'Other', views: 500000, engagement: 25000, videos: 20, avgViews: 25000, avgEngagement: 1250, avgDuration: 1200 }
  ]
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="bg-green-100 p-4 rounded-lg">
        <h1 className="text-2xl font-bold text-green-900">🎉 Dashboard is Working!</h1>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Monitor your channel performance and growth trends</p>
        </div>
      ...
      {/* Test section to ensure rendering */}
      <div className="bg-blue-100 p-4 rounded-lg">
        <h3 className="text-lg font-semibold text-blue-900">Debug Info</h3>
        <p className="text-blue-800">Component is rendering! kpiData: {kpiData ? 'Loaded' : 'Not loaded'}</p>
        <p className="text-blue-800">Loading state: {isLoading ? 'Yes' : 'No'}</p>
        <p className="text-blue-800">Chart data: {chartData ? 'Loaded' : 'Not loaded'}</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Video Performance by Type</h3>
      ...
      {/* Topic Categories Performance */}
      <div className="card mb-6">
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-semibold text-gray-900">Topic Categories Performance</h3>
          <MessageCircle className="w-5 h-5 text-gray-400" />
        </div>
        <ResponsiveContainer width="100%" height={400}>
          <BarChart data={topicCategoriesData} layout="horizontal">
            <CartesianGrid strokeDasharray="3 3" />
      ...
      {/* Recent Activity */}
      <div className="card">
        <h3 className="text-lg font-semibold text-gray-900 mb-6">Recent Channel Activity</h3>
